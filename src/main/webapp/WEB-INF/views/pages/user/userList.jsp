...
<%-- <div class="list-data">
 ...
 <div class="tab-userList">
  <button class="tablinks" onclick="openCity(event, 'Applicant')">Applicant List</button>
  <button class="tablinks" onclick="openCity(event, 'Company')">Company List</button>
  <button class="tablinks" onclick="openCity(event, 'Admin')">Admin List</button>
</div>
</div>
<!-- Tab content -->
