  ...
  <div class="signup-container">
    ...
    <form:form class="form-container" action="${register }"
      ...
      <div class="form-group">
        ...
        <form:input path="username" value="${userForm.username }" type="text"
      ...
      <div class="form-group">
        ...
        <form:input path="password" value="${userForm.password }" type="password"
          placeholder="Pleease Enter Password" name="password"
          class="sign-input" />
      </div>
      <div class="form-group">
        <label for="confirm-password">Confirm Password</label><br>
        <form:input path="confirmPwd" value="${userForm.confirmPwd }" type="password"
          placeholder="Pleease Enter Password" name="password"
          class="sign-input" />
      </div>
      <div class="form-group">
        <label for="role">Select Role:</label><br>
        <form:select path="authority.id" value="${userForm.authority }" class="sign-select">
